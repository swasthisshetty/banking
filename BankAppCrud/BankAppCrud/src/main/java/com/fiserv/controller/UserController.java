...
public class UserController {
	...
	@RequestMapping(value = "/users/deposit/{accountNum}/{amountToTransfer}", method = RequestMethod.POST)
	public String deposit(@PathVariable("accountNum") long accountNum,@PathVariable("amountToTransfer") double amountToTransfer) {
		userService.deposit(accountNum, amountToTransfer);
